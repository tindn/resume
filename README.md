...
```
Product focused engineer, 13 years of experience in full stack web technologies, mobile app development, and AI applications with LLMs.
```

**_2013-2018: building full stack web applications_**
> Focus on working across back-end and front-end to deliver complete software solutions.

<sub>.NET, ReactJS, AngularJS, Node.js, MS SQL, MySQL, C#, JavaScript, SQL, HTML, CSS</sub>

**_2018 - 2023: building Android and iOS mobile apps using React Native_**
> Focus on product development, mentoring junior engineers, and setting technical foundations.

<sub>React Native, ReactJS, NestJS, NodeJS, PostgreSQL, SQLite, TypeScript, SQL</sub>

**_2024 - now: building LLM-powered features & agentic products_**
> Find PMF for new agentic products while applying good software engineering to building with LLM.

<sub>GPT & Claude models, LangChain, OpenAI SDK, FastAPI, Temporal, Python, TypeScript</sub>

---

**Senior Software Engineer @ [Klaviyo.](https://klaviyo.com)** Boston, MA | _Jan 2024 - Present_

- Technical lead for Klaviyo Composer Agent, an AI assistant for autonomous marketing workflows.
